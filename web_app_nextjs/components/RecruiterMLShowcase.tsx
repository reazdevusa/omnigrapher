  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      ...
      <Tabs defaultValue="speech" className="w-full">
        ...
        <TabsContent value="speech" className="mt-4"><SpeechTab /></TabsContent>
        <TabsContent value="vision" className="mt-4"><VisionTab /></TabsContent>
        <TabsContent value="ml" className="mt-4"><MLEngineTab /></TabsContent>
      </Tabs>
